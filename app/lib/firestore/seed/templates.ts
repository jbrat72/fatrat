...
export const GLOBAL_TEMPLATES: ProgramTemplate[] = [
  ...
  /* ---- SINGLE WORKOUTS ---- a la carte routines for ad-hoc training */
  {
    id: 'wk-push-day',
    name: 'Push Day',
    description: 'Chest, shoulders, triceps. ~45 min.',
    kind: 'workout',
    category: 'upper-body',
    daysPerWeek: 1,
    split: 'upper-lower',
    ...
    minMode: 'BASIC',
    restSeconds: 120,
    weeks: week([{ dayLabel: 'Push', slots: [
      slot('bench-press-barbell', 4, 6, 10),
      slot('ohp-dumbbell', 3, 8, 12),
      slot('lateral-raise-dumbbell', 3, 12, 15),
      slot('tricep-pushdown-cable', 3, 10, 15),
    ]}]),
  },
  {
    id: 'wk-pull-day',
    name: 'Pull Day',
    description: 'Back and biceps. ~45 min.',
    kind: 'workout',
    category: 'upper-body',
    daysPerWeek: 1,
    split: 'upper-lower',
    ...
    minMode: 'BASIC',
    restSeconds: 120,
    weeks: week([{ dayLabel: 'Pull', slots: [
      slot('pull-up', 4, 5, 10),
      slot('row-barbell', 3, 6, 10),
      slot('face-pull', 3, 12, 15),
      slot('curl-barbell', 3, 8, 12),
    ]}]),
  },
  {
    id: 'wk-upper-mass',
    name: 'Upper Body Mass',
    description: 'Heavy compounds plus arms. ~60 min.',
    kind: 'workout',
    category: 'upper-body',
    daysPerWeek: 1,
    split: 'upper-lower',
    ...
    minMode: 'BASIC',
    restSeconds: 150,
    weeks: week([{ dayLabel: 'Upper Mass', slots: [
      slot('bench-press-barbell', 4, 5, 8),
      slot('row-barbell', 4, 6, 10),
      slot('ohp-barbell', 3, 6, 10),
      slot('pull-up', 3, 5, 10),
      slot('curl-dumbbell', 3, 8, 12),
      slot('tricep-pushdown-cable', 3, 10, 12),
    ]}]),
  },
  {
    id: 'wk-squat-day',
    name: 'Squat Day',
    description: 'Quad-focused leg day. ~50 min.',
    kind: 'workout',
    category: 'lower-body',
    daysPerWeek: 1,
    split: 'upper-lower',
    ...
    minMode: 'BASIC',
    restSeconds: 180,
    weeks: week([{ dayLabel: 'Squat', slots: [
      slot('squat-back-barbell', 4, 5, 8),
      slot('leg-press', 3, 8, 12),
      slot('leg-extension', 3, 10, 15),
      slot('leg-curl-seated', 3, 10, 15),
      slot('calf-raise-standing', 4, 10, 15),
    ]}]),
  },
  {
    id: 'wk-hinge-day',
    name: 'Hinge Day',
    description: 'Hamstring and glute focus. ~50 min.',
    kind: 'workout',
    category: 'lower-body',
    daysPerWeek: 1,
    split: 'upper-lower',
    ...
    minMode: 'BASIC',
    restSeconds: 180,
    weeks: week([{ dayLabel: 'Hinge', slots: [
      slot('rdl-barbell', 4, 6, 10),
      slot('hip-thrust', 3, 8, 12),
      slot('leg-curl-lying', 3, 10, 15),
      slot('cable-pull-through', 3, 10, 12),
      slot('calf-raise-seated', 3, 12, 15),
    ]}]),
  },
  {
    id: 'wk-core-crusher',
    name: 'Core Crusher',
    description: 'A focused 20-minute core finisher.',
    kind: 'workout',
    category: 'core',
    daysPerWeek: 1,
    split: 'upper-lower',
    ...
    minMode: 'BASIC',
    restSeconds: 45,
    weeks: week([{ dayLabel: 'Core', slots: [
      slot('plank', 3, 30, 60),
      slot('hanging-leg-raise', 3, 8, 12),
      slot('ab-wheel', 3, 8, 12),
      slot('pallof-press', 3, 10, 15),
    ]}]),
  },
  {
    id: 'wk-quick-core',
    name: 'Quick Core',
    description: '10 minutes — minimal equipment.',
    kind: 'workout',
    category: 'core',
    daysPerWeek: 1,
    split: 'upper-lower',
    ...
    minMode: 'BASIC',
    restSeconds: 30,
    weeks: week([{ dayLabel: 'Quick Core', slots: [
      slot('plank', 3, 30, 45),
      slot('bicycle-crunch', 3, 15, 20),
      slot('dead-bug', 3, 10, 12),
    ]}]),
  },
  {
    id: 'wk-quick-full-body',
    name: 'Quick Full Body',
    description: 'Four compounds, ~30 min in a hotel or home gym.',
    kind: 'workout',
    category: 'full-body',
    daysPerWeek: 1,
    split: 'full-body',
    ...
    minMode: 'BASIC',
    restSeconds: 90,
    weeks: week([{ dayLabel: 'Full Body', slots: [
      slot('goblet-squat', 3, 8, 12),
      slot('pushup', 3, 8, 15),
      slot('row-dumbbell', 3, 8, 12),
      slot('plank', 3, 30, 60),
    ]}]),
