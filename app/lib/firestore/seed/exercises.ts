...
export const GLOBAL_EXERCISES: ExerciseDefinition[] = [
  ...
  { id: 'chest-fly-dumbbell', name: 'Dumbbell Chest Fly', primaryMuscle: 'chest', equipment: 'dumbbell', patterns: ['isolation','push'], requiresEquipment: ['Bench — Flat'] },
  { id: 'cable-crossover', name: 'Cable Crossover', primaryMuscle: 'chest', equipment: 'cable', patterns: ['isolation','push'] },
  { id: 'pec-deck', name: 'Pec Deck', primaryMuscle: 'chest', equipment: 'machine', patterns: ['isolation','push'], requiresEquipment: ['Pec Deck'] },
  ...
  { id: 'lateral-raise-machine', name: 'Machine Lateral Raise', primaryMuscle: 'shoulders', equipment: 'machine', patterns: ['isolation'], requiresEquipment: ['Gym Machine'] },
  ...
  { id: 'rear-delt-fly-machine', name: 'Reverse Pec Deck', primaryMuscle: 'shoulders', equipment: 'machine', patterns: ['isolation','pull'], requiresEquipment: ['Pec Deck'] },
  ...
  { id: 'preacher-curl', name: 'Preacher Curl', primaryMuscle: 'biceps', equipment: 'machine', patterns: ['isolation','pull'], requiresEquipment: ['Gym Machine'] },
  ...
  { id: 'leg-extension', name: 'Leg Extension', primaryMuscle: 'quads', equipment: 'machine', patterns: ['isolation'], requiresEquipment: ['Leg Curl/Extension'] },
  ...
  { id: 'hip-abduction-machine', name: 'Hip Abduction Machine', primaryMuscle: 'glutes', equipment: 'machine', patterns: ['isolation'], requiresEquipment: ['Gym Machine'] },
  ...
  // ---- Calves ----
  { id: 'calf-raise-standing', name: 'Standing Calf Raise', primaryMuscle: 'calves', equipment: 'machine', patterns: ['isolation'], requiresEquipment: ['Gym Machine'] },
  { id: 'calf-raise-seated', name: 'Seated Calf Raise', primaryMuscle: 'calves', equipment: 'machine', patterns: ['isolation'], requiresEquipment: ['Gym Machine'] },
  { id: 'calf-raise-leg-press', name: 'Leg Press Calf Raise', primaryMuscle: 'calves', equipment: 'machine', patterns: ['isolation'], requiresEquipment: ['Leg Press'] },
  ...
  { id: 'hanging-leg-raise', name: 'Hanging Leg Raise', primaryMuscle: 'core', equipment: 'bodyweight', patterns: ['isolation'], metric: 'reps', requiresEquipment: ['Pull-Up Bar'] },
  { id: 'ab-wheel', name: 'Ab Wheel Rollout', primaryMuscle: 'core', equipment: 'bodyweight', patterns: ['isolation'], metric: 'reps', requiresEquipment: ['Ab Wheel'] },
  ...
  { id: 'inverted-curl', name: 'Inverted Curl', primaryMuscle: 'biceps', secondaryMuscles: ['back'], equipment: 'bodyweight', patterns: ['isolation','pull'], metric: 'reps', requiresEquipment: ['Pull-Up Bar'] },
  { id: 'doorway-curl', name: 'Doorway Curl', primaryMuscle: 'biceps', equipment: 'bodyweight', patterns: ['isolation','pull'], metric: 'reps' },
  { id: 'dead-hang', name: 'Dead Hang', primaryMuscle: 'forearms', equipment: 'bodyweight', patterns: ['isolation'], metric: 'time', requiresEquipment: ['Pull-Up Bar'] },
  { id: 'towel-hang', name: 'Towel Hang', primaryMuscle: 'forearms', equipment: 'bodyweight', patterns: ['isolation'], metric: 'time', requiresEquipment: ['Pull-Up Bar'] },
  ...
  { id: 'pullup-wide', name: 'Wide-Grip Pull-up', primaryMuscle: 'back', secondaryMuscles: ['biceps'], equipment: 'bodyweight', patterns: ['compound','pull'], metric: 'reps', requiresEquipment: ['Pull-Up Bar'] },
  { id: 'pullup-neutral', name: 'Neutral-Grip Pull-up', primaryMuscle: 'back', secondaryMuscles: ['biceps'], equipment: 'bodyweight', patterns: ['compound','pull'], metric: 'reps', requiresEquipment: ['Pull-Up Bar'] },
  { id: 'pullup-commando', name: 'Commando Pull-up', primaryMuscle: 'back', secondaryMuscles: ['biceps'], equipment: 'bodyweight', patterns: ['compound','pull'], metric: 'reps', requiresEquipment: ['Pull-Up Bar'] },
  { id: 'pullup-archer', name: 'Archer Pull-up', primaryMuscle: 'back', secondaryMuscles: ['biceps'], equipment: 'bodyweight', patterns: ['compound','pull'], metric: 'reps', requiresEquipment: ['Pull-Up Bar'] },
